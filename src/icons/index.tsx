  ...
  return (
    ...
    >
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.02.12-.115.26-.265.348a7.493 7.493 0 0 0-.986.676c-.133.111-.306.158-.477.128l-1.564-.312a1.875 1.875 0 0 0-2.008.823 1.87 1.87 0 0 0-.177 1.593l.687 1.905c.062.17.043.357-.052.514a7.493 7.493 0 0 0-.338.916 1.873 1.873 0 0 0-.052.514l-.687 1.904a1.875 1.875 0 0 0 2.185 2.416l1.564-.312c.171-.034.344.017.477.128.312.26.642.496.986.676.15.088.245.228.265.348l.178 1.072c.151.904.933 1.567 1.85 1.567h2.344c.917 0 1.699-.663 1.85-1.567l.178-1.072c.02-.12.115-.26.265-.348a7.524 7.524 0 0 0 .986-.676c.133-.111.306-.158.477-.128l1.564.312a1.875 1.875 0 0 0 2.008-.823 1.873 1.873 0 0 0 .177-1.593l-.687-1.905a1.873 1.873 0 0 0-.052-.514 7.493 7.493 0 0 0-.338-.916 1.873 1.873 0 0 0 .052-.514l.687-1.904a1.875 1.875 0 0 0-2.185-2.416l-1.564.312c-.171.034-.344-.017-.477-.128a7.524 7.524 0 0 0-.986-.676 1.873 1.873 0 0 0-.265-.348l-.178-1.072A1.875 1.875 0 0 0 13.422 2.25h-2.344ZM12 16.125a3.375 3.375 0 1 0 0-6.75 3.375 3.375 0 0 0 0 6.75Z'
        fill={color}
      />
    </svg>
  );

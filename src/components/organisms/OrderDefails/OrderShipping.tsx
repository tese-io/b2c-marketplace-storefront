...
const OrderShipping = async ({ order }: ShippingDetailsProps) => {
  ...
  return (
    <div className="tese-order-shipping">
      <div className="tese-order-shipping-block">
        <h3 className="tese-order-shipping-label">{t("shippingAddress")}</h3>
      ...
      <div className="tese-order-shipping-block" data-testid="shipping-contact-summary">
        <h3 className="tese-order-shipping-label">{t("contact")}</h3>
      ...
      {shippingMethod && (
        <div className="tese-order-shipping-block" data-testid="shipping-method-summary">
          <h3 className="tese-order-shipping-label">{t("deliveryMethod")}</h3>
          <p>
            {shippingMethod.name}{' '}
            ({convertToLocale({
      ...
      {payment && (
        <div className="tese-order-shipping-block">
          <h3 className="tese-order-shipping-label">{t("paymentMethod")}</h3>
